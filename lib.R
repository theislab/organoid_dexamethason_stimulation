# Taken from: https://github.com/ChristophH/in-lineage/blob/master/R/lib.R
# Published under GNU General Public License v3.0. Full License available here: https://github.com/ChristophH/in-lineage/blob/master/LICENSE
# Copyright by Christoph Hafemeister
